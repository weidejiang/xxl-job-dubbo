...
<#-- echarts -->
<script src="${request.contextPath}/xxl-job-admin/static/plugins/echarts/echarts.common.min.js"></script>
<script src="${request.contextPath}/xxl-job-admin/static/js/index.js"></script>
</body>
</html>
