...
<head>
	...
	<!-- DataTables -->
  	...
  	<!-- daterangepicker -->
  	<link rel="stylesheet" href="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<script src="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="${request.contextPath}/xxl-job-admin/static/js/joblog.index.1.js"></script>
</body>
</html>
