...
<head>
	...
	<!-- DataTables -->
  	<link rel="stylesheet" href="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
			              	...
			              	<table id="job_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
                                        ...
                                        <th name="className">${I18n.jobinfo_field_class_name}</th>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
<#--                        <div class="form-group">-->
<#--                            <label for="firstname" class="col-sm-2 control-label">调用类型方式<font color="red">*</font></label>-->
<#--                            <div class="col-sm-4">-->
<#--                                <select class="form-control glueType" name="type" >-->
<#--                                    <#list TypeEnum as item>-->
<#--                                        <option value="${item.code}" >${item.msg}</option>-->
<#--                                    </#list>-->
<#--                                </select>-->
<#--                            </div>-->
<#--                            <label for="firstname" class="col-sm-2 control-label">分组<font>*</font></label>-->
<#--                            <div class="col-sm-4"><input type="text" class="form-control" name="group" placeholder="${I18n.system_please_input}version" maxlength="100" ></div>-->
<#--                        </div>-->
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_class_name}<font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="className" placeholder="${I18n.system_please_input}" maxlength="50" ></div>
                    </div>
...
<#--                            </div>-->
<#--                            <label for="firstname" class="col-sm-2 control-label">分组<font>*</font></label>-->
<#--                            <div class="col-sm-4"><input type="text" class="form-control" name="group" placeholder="${I18n.system_please_input}" maxlength="100" ></div>-->
<#--                        </div>-->
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_class_name}<font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="className" placeholder="${I18n.system_please_input}" maxlength="50" ></div>
                    </div>
...
<!-- DataTables -->
<script src="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- moment -->
<script src="${request.contextPath}/xxl-job-admin/static/adminlte/bower_components/moment/moment.min.js"></script>
<#-- cronGen -->
<script src="${request.contextPath}/xxl-job-admin/static/plugins/cronGen/cronGen<#if I18n.admin_i18n?default('')?length gt 0 >_${I18n.admin_i18n}</#if>.js"></script>
<script src="${request.contextPath}/xxl-job-admin/static/js/jobinfo.index.1.js"></script>
</body>
</html>
